    ...
    <div>
      ...
      <section id="Newest" className="flex flex-col gap-3 px-4 mt-[30px]">
        ...
        <div className="flex flex-col gap-3">
          <div
            className="flex items-center w-full rounded-[20px] border border-[#EFF2F7] p-[10px_14px] gap-[14px] bg-white hover:ring-1 hover:ring-[#362EED] transition-all duration-300 cursor-pointer"
            onClick={() => router.push("/browse/1")}
          >
