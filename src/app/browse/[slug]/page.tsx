...
import BorderBack from "@/assets/images/icons/back-border.svg";
...
import Gallery from "@/assets/images/photos/gallery-1.png";
    ...
    >
      ...
      <div id="Bottom-CTA" className="relative flex h-[93px] z-20">
        <div className="fixed bottom-0 w-full flex items-center justify-between max-w-[640px] p-5 bg-alpina-black">
          ...
          <div
            className="w-fit rounded-full p-[14px_24px] bg-alpina-blue font-bold text-white cursor-pointer"
            onClick={() => {
              router.push("/booking");
            }}
          >
